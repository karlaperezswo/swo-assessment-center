            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="font-semibold text-gray-700">
                  {t('executiveSummary.serverEOL', { count: eolCount })}
                </p>
                <p className="text-sm text-gray-500 mt-1">
                  {eolRisk === 'high' ? t('executiveSummary.riskHigh') : eolRisk === 'medium' ? t('executiveSummary.riskMedium') : t('executiveSummary.riskLow')}
                </p>
