...
const GRADIENT = 'linear-gradient(135deg, #7c3aed 0%, #4f46e5 55%, #2563eb 100%)';
const GRADIENT_H = 'linear-gradient(90deg, #7c3aed 0%, #4f46e5 55%, #2563eb 100%)';
...
export function TechnicalMemory() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── TAB: Proyecto ─────────────────────────────────────────────────── */}
      {activeTab === 'project' && (
        <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #c4b5fd', overflow: 'hidden' }}>
            ...
            {[
              ...
              <div key={f.field}>
                ...
                <input value={(data[f.field] as string) || ''} onChange={e => set(f.field, e.target.value)}
                  ...
                  style={{ width: '100%', padding: '8px 12px', borderRadius: 7, border: '1px solid #c4b5fd',
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <input value={data.clientUrl} onChange={e => set('clientUrl', e.target.value)}
                  ...
                  style={{ flex: 1, padding: '8px 12px', borderRadius: 7, border: '1px solid #c4b5fd', fontSize: 13, outline: 'none' }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #c4b5fd', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '16px 20px', display: 'flex', gap: 8 }}>
              <input value={serviceSearch} onChange={e => setServiceSearch(e.target.value)}
                ...
                style={{ flex: 1, padding: '9px 14px', borderRadius: 8, border: '1px solid #c4b5fd',
          ...
          {data.services.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '40px 20px', color: '#94a3b8',
              background: '#fff', borderRadius: 10, border: '1px dashed #c4b5fd' }}>
              <BookOpen style={{ width: 40, height: 40, margin: '0 auto 12px', color: '#c4b5fd' }} />
            ...
            data.services.map(svc => (
              <div key={svc.id} style={{ background: '#fff', borderRadius: 10, border: '1px solid #c4b5fd', overflow: 'hidden' }}>
                ...
                {expandedService === svc.id && (
                  <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                      <div>
                        ...
                        <button onClick={() => updateService(svc.id, 'advantages', [...svc.advantages, ''])}
                          style={{ fontSize: 11, color: '#7c3aed', background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    <div style={{ fontSize: 10, color: '#94a3b8' }}>
                      Fuente: <a href={svc.docsUrl} target="_blank" rel="noreferrer" style={{ color: '#4f46e5' }}>{svc.docsUrl}</a>
                    </div>
                  </div>
                )}
              </div>
      ...
      {activeTab === 'document' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            ...
            <div key={f.field} style={{ background: '#fff', borderRadius: 10, border: '1px solid #c4b5fd', overflow: 'hidden' }}>
              <div style={{ background: GRADIENT, padding: '10px 18px' }}>
      ...
      {activeTab === 'letter' && (
        <div style={{ background: '#fff', borderRadius: 10, border: '1px solid #c4b5fd', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ padding: '12px 16px', background: '#f5f3ff', borderRadius: 8, border: '1px solid #c4b5fd',
