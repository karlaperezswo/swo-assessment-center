@echo off
echo ============================================
echo Probando Backend paso a paso
echo ============================================
echo.
...
if not exist "package.json" (
    echo ERROR: package.json no existe en la carpeta backend
    pause
    exit /b 1
)
...
echo.
echo El servidor deberia mostrar: "Server running on http://localhost:4000"
echo.
